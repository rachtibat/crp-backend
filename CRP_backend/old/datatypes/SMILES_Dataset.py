...
class SMILES_Dataset:
    ...
    def visualize_data_sample(self, image_np: np.ndarray, size: int, image_index) -> np.ndarray:
        """
    ...
    def gen_visualize_filter(self, codes, most_neuron_index, rf, rf_to_neuron_index, filter_index, size, selected=(0, 10), padding=False, data_indices=[]):
